...
const SaveLoadCompat _company_sl_compat[] = {
	...
	SLC_VAR("clear_limit"),
	SLC_VAR("tree_limit"),
	SLC_VAR("company_type"),
	SLC_VAR("parent_company"),
	SLC_VAR("infra_sharing_mode"),
	SLC_VAR("infra_fees.rail_fee_per_tile"),
	SLC_VAR("infra_fees.road_fee_per_tile"),
	SLC_VAR("infra_fees.station_fee_per_use"),
	SLC_VAR("infra_fees.airport_fee_per_use"),
	SLC_VAR("settings"),
	SLC_VAR("old_ai"),
	SLC_VAR("cur_economy"),
	SLC_VAR("old_economy"),
